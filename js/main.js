...
// const fechaValida = (date) => DateTime.fromISO(date) >= ahora;
...
//   if (!fechaPartida.isValid || !fechaRegreso.isValid || fechaRegreso < fechaPartida || !fechaValida(inputPartida)) {
//     showError("Por favor, ingrese fechas válidas");
//     return false;
//   }
...
// partida.addEventListener("change", () => {partida.min = ahora.toISODate()});
...
//   e.preventDefault();
//   if (validateForm()) {
//     // Realizar acciones adicionales o enviar formulario
//   }
// });
